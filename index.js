...
router.get('/get/html', function(req, res) {
    ...
    let xml = fs.readFileSync('movies.xml', 'utf8'), //read in the XML file
        xsl = fs.readFileSync('Movies.xsl', 'utf8'); //read in the XSL file
...
router.post('/post/json', function(req, res) {
    ...
    function appendJSON(obj) {
        ...
        XMLtoJSON('movies.xml', function (err, result){
            if (err) throw (err);
            ...
            JSONtoXML('movies.xml', result, function(err){
